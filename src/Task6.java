...
class task6 {
    ...
    public static String translateSentence(String word)
    {
        ...
        {
            if(isVowel(newWord[i].charAt(0)))
            {
                newWord[i] = newWord[i] + "yay";
            }
            else
            {
                int firstVowelIndex = 0;
    ...
    public static void main(String[] main) {
        ...
        System.out.println(translateWord("").equals(""));

        System.out.println(translateSentence("Do you think it is going to rain today?").equals("Oday ouyay inkthay ityay isyay oinggay otay ainray odaytay?"));

        System.out.println(validColor("rgba(0,0,0,0.123456789)") == true);

        System.out.println(stripUrlParams("https://edabit.com", new String[] {"b"}).equals("https://edabit.com"));
        ...
        System.out.println(longestNonrepeatingSubstring("abcda").equals("abcd"));

        System.out.println(convertToRoman(16).equals("XVI"));
