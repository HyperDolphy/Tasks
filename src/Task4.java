...
class Task4 {
    ...
    public static int[] count_digits(long num) {
    ...
    public static boolean trouble(long a, long b){
        int[] a_counter = count_digits(a);
        int[] b_counter = count_digits(b);
        for (int i = 0; i < 10; i++)
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.equals(split("((())())(()(()()))"), new String[] {"((())())", "(()(()()))"}));
        System.out.println(toSnakeCase("getColor").equals("get_color"));
        System.out.println( overTime(new double[] {16, 18, 30, 1.8}).equals("$84.0"));
        System.out.println(BMI("154 pounds", "2 meters").equals("17.5 Underweight"));
        System.out.println(bugger(4) == 0);
        System.out.println(toStarShorthand("").equals(""));
